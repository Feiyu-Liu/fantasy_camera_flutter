...
class GenerationRecords extends Table with TableInfo {
  ...
  late final GeneratedColumn<int> generationStartedAt = GeneratedColumn<int>(
...
class GenerationAnimationSequenceStates extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  GenerationAnimationSequenceStates(this.attachedDatabase, [this._alias]);
  ...
  @override
  GenerationAnimationSequenceStates createAlias(String alias) {
    return GenerationAnimationSequenceStates(attachedDatabase, alias);
  }
...
class DatabaseAtV5 extends GeneratedDatabase {
  ...
  late final GenerationAnimationSequenceStates
  generationAnimationSequenceStates = GenerationAnimationSequenceStates(this);
  @override
